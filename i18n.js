window.translations = {
  en: {
    ...
    hero_subtitle: "Our beloved black cat is lost in <strong>Taman Antarabangsa, Likas</strong>. We need your help to find him.",
    cta_found: '<span class="icon" style="margin-right: 8px; font-size: 1.2em">💬</span> I Found Him',
    cta_details: "View Details",
    status_header: '<span class="blinking-dot">●</span> LIVE UPDATE',
    ...
    story_box_title: "🏠 Personality & Safety",
    ...
    story_box_p3: "🙏 Please let him back home safely.",
    ...
    last_seen_desc: "Batman was last seen around our house in:",
    ...
    compassion_title: "💌 A Message to the Person Who Has Him",
    compassion_p1: "We ask you nicely: if you have taken Batman, <strong>please bring him back to us.</strong> We promise that <strong>we will not ask any questions</strong> if you return him safely.",
    ...
    compassion_p3: "If you cannot afford to buy food or provide for him, <strong>please contact us.</strong> We are willing to <span class=\"highlight-text\">transfer money to you for his well-being</span>. His safety and health are all that matter to us.",
    whatsapp_cta: '<span class="icon" style="margin-right: 8px">📱</span> WhatsApp Us Now',
  ...
  ms: {
    ...
    hero_subtitle: "Kucing hitam kesayangan kami hilang di <strong>Taman Antarabangsa, Likas</strong>. Kami perlukan bantuan anda untuk mencarinya.",
    cta_found: '<span class="icon" style="margin-right: 8px; font-size: 1.2em">💬</span> Saya Jumpa Dia',
    cta_details: "Lihat Maklumat",
    status_header: '<span class="blinking-dot">●</span> KEMASKINI LANGSUNG',
    ...
    game_win: "Anda Temui Jalan Pulang! 🏠",
    ...
    story_box_title: "🏠 Personaliti & Keselamatan",
    ...
    story_box_p3: "🙏 Tolong biarkan dia pulang dengan selamat.",
    ...
    last_seen_desc: "Batman kali terakhir dilihat di sekitar rumah kami di:",
    last_seen_loc: "Taman Antarabangsa, Likas",
    ...
    compassion_title: "💌 Pesan Kepada Penemu",
    compassion_p1: "Kami minta dengan baik: jika anda telah mengambil Batman, <strong>tolong pulangkan dia kepada kami.</strong> Kami janji <strong>kami tidak akan bertanya apa-apa</strong> jika anda pulangkan dia dengan selamat.",
    ...
    compassion_p3: "Jika anda tidak mampu membeli makanan, <strong>sila hubungi kami.</strong> Kami sedia <span class=\"highlight-text\">memindahkan wang kepada anda untuk kebaikannya</span>. Keselamatan dan kesihatannya adalah yang paling utama bagi kami.",
    whatsapp_cta: '<span class="icon" style="margin-right: 8px">📱</span> WhatsApp Kami Sekarang',
  ...
  zh: {
    ...
    nav_help: "帮忙",
    hero_badge: "🚨 寻猫启事",
    hero_title_sub: "失踪的黑猫",
    hero_subtitle: "我们心爱的黑猫在 <strong>Taman Antarabangsa, Likas</strong> 走失了。我们需要您的帮助寻找他。",
    cta_found: '<span class="icon" style="margin-right: 8px; font-size: 1.2em">💬</span> 我找到了',
    cta_details: "查看详情",
    status_header: '<span class="blinking-dot">●</span> 实时更新',
    status_title: "正在检查闭路电视",
    status_desc: "我们目前正在查看附近的监控录像，以追踪 Batman 的行踪。",
    status_loc_label: "地点: Taman Antarabangsa",
    status_val: "状态: 进行中...",
    game_title: "帮助 Batman 回家",
    game_instr: "使用 <strong>方向键</strong> 或 <strong>点击</strong> 避开障碍物，指引 Batman 回家！",
    game_start: "开始游戏",
    game_over: "游戏结束！",
    game_try_again: "再试一次",
    game_win: "你找到了家！ 🏠",
    game_win_msg: "谢谢你带 Batman 回家！",
    game_play_again: "再玩一次",
    story_title: "谁是 Batman？",
    story_p1: "Batman 是一只家养的黑猫，有着明亮的黄色眼睛。他的特征是<strong>尾巴很长</strong>（几乎和身体一样长），而且<strong>完全没有白斑</strong>。",
    story_p2: "他走失时<strong>戴着项圈</strong>。他是我们深爱的家人，从家中走失了。",
    story_box_title: "🏠 性格与安全",
    story_box_p1: "Batman 是一只非常友善的猫，但请注意：<strong>他的友善并不代表他想跟你回家。</strong>",
    story_box_p2: "他<strong>在这个家出生</strong>，一生都住在这里。他属于非常想念他的家人。",
    story_box_p3: "🙏 请让他安全回家。",
    story_note: "注：虽然电影《Flow》最近让黑猫很受欢迎，但 Batman <strong>不是</strong> 电影里的那只猫。他是我们珍视的宠物，需要回家。",
    photos_title: "真实照片",
    clues_title: "详细特征",
    clue_color: "颜色",
    clue_color_desc: "全黑<br><span style=\"font-size:0.6em; opacity:0.7\">（无白斑）</span>",
    clue_collar: "项圈",
    clue_collar_desc: "黑色<br><span style=\"font-size:0.6em; opacity:0.7\">带黄条纹</span>",
    clue_tail: "尾巴",
    clue_tail_desc: "非常长",
    clue_reward: "酬谢",
    clue_reward_desc: "现金酬劳",
    clue_policy: "政策",
    clue_policy_desc: "不过问详情",
    last_seen_title: "最后目击",
    last_seen_desc: "Batman 最后在我们家附近被看到，地点在：",
    last_seen_loc: "Taman Antarabangsa, Likas",
    last_seen_help: "如果您见过他或不小心带了他回家，请帮我们要回他。",
    help_title: "帮助 Batman 回家",
    help_desc: "如果您在 Likas 地区看到一只眼睛明亮黄色的黑猫，请立即联系我们。",
    alert_title: "紧急：非法买卖警告",
    alert_desc: "如果您看到有人试图出售符合 Batman 特征的猫，<strong>请立即告诉我们。</strong> 我们需要您的帮助带他回家。",
    compassion_title: "💌 给收留者的一封信",
    compassion_p1: "我们恳求您：如果您带走了 Batman，<strong>请把他还给我们。</strong> 我们承诺，如果您安全归还他，<strong>我们绝不过问。</strong>",
    compassion_p2: "但是，如果您选择不归还，我们求您<strong>请好好照顾他。</strong> 他生于我们家，对我们来说非常重要。",
    compassion_p3: "如果您负担不起猫粮，<strong>请联系我们。</strong> 我们愿意<span class=\"highlight-text\">汇款给您以确保他的生活</span>。他的安全和健康是我们唯一关心的。",
    whatsapp_cta: '<span class="icon" style="margin-right: 8px">📱</span> 立即 WhatsApp 我们',
    contact_title: "联系我们",
    contact_desc: "我们 24/7 全天候待命。如果您有任何消息，请随时联系。",
    contact_chat: "WhatsApp 聊天",
    contact_call: "或直接致电 <a href=\"tel:+60143192305\" style=\"color: var(--accent); text-decoration: none;\">+60 14-319 2305</a>",
    game_distance: "距离: "
  }
};
