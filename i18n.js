window.translations = {
  en: {
    ...
    compassion_p1: "We ask you nicely: if you have accidentally taken Batman, <strong>please bring him back to us.</strong> We promise that <strong>we will not ask any questions</strong> if you return him safely.",
  ...
  ms: {
    ...
    compassion_p1: "Kami minta dengan baik: jika anda terambil Batman secara tidak sengaja, <strong>tolong pulangkan dia kepada kami.</strong> Kami janji <strong>kami tidak akan bertanya apa-apa</strong> jika anda pulangkan dia dengan selamat.",
  ...
  zh: {
    ...
    compassion_p1: "我们恳求您：如果您不小心带走了 Batman，<strong>请把他还给我们。</strong> 我们承诺，如果您安全归还他，<strong>我们绝不过问。</strong>",
    compassion_p2: "但是，如果您选择不归还，我们求您<strong>请好好照顾他。</strong> 他生于我们家，对我们来说非常重要。",
    compassion_p3: "请怜悯抚养并深爱他的主人。他的安全和健康是我们唯一关心的。",
